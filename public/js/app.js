  ...
  methods: {
    ...
    sendQuestions: function sendQuestions() {
      ...
      if (location.hostname == "localhost") {
        url = "http://localhost/admin/search/" + searchId + "/questions/create";
      } else {
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-52340eb8", Component.options)
  } else {
    hotAPI.reload("data-v-52340eb8", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-52340eb8", module.exports)
  }
}
